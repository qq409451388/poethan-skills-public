...
function ServerModal({ draft, setDraft, saving, connectionResult, close, save, test }: { draft: ServerProfile; setDraft: (value: ServerProfile) => void; saving: boolean; connectionResult: string; close: () => void; save: () => void; test: () => void }) {
