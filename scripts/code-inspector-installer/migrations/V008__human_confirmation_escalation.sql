...
-- 增加 Issue 级 Human 最终兜底状态与结构化请求/决定活动。
...
CREATE TABLE review_issue_new (
    ...
    status TEXT NOT NULL CHECK (status IN ('PROPOSED', 'DESIGN_REQUIRED', 'DESIGN_PENDING_REVIEW', 'IN_PROGRESS', 'ON_HOLD', 'BLOCKED', 'INSPECTOR_CONFIRMATION_REQUIRED', 'IMPLEMENTED_PENDING_REVIEW', 'REDESIGN_REQUIRED', 'HUMAN_CONFIRMATION_REQUIRED', 'CONFIRMED', 'CANCELLED')),
